...
public class CheckersGameNotPOO {
    ...
    public static void main(String[] args){
        ...
        JFrame frame = new JFrame("Ceci est la fenêtre d'affichage de mon jeu de dames");
        int length = 10;
        ...
        //Ajout des pions cyans sur les 4 premieres lignes du damier
        setPiecesCheckersBoard(checkersBoard, length,0,4,Color.CYAN);
        //Ajout des pions rouges sur les 4 dernieres lignes du damier
